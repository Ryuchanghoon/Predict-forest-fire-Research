...
data_dir = pathlib.Path("/content/data/colorEnhanced/")
TRAIN_DIR = data_dir / "train"
VALID_DIR = data_dir / "val"


#/content/data/colorEnhanced/train


#TRAIN_DIR = [
#  '/content/colorEnhanced_train_Fire',
#  '/content/colorEnhanced_train_NoFire'
#]


#VALID_DIR = [
#  '/content/colorEnhanced_val_Fire',
#  '/content/colorEnhanced_val_NoFire'
#]
